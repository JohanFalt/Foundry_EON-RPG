...
export class DialogMigrationWizard extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        ...
        classes: ['EON', 'migration-wizard-dialog'],
        position: {
            width: 600,
            height: 500
        },
    ...
    static PARTS = {
        body: {
            template: 'systems/eon-rpg/templates/dialogs/dialog-migration-wizard.hbs'
        }
    }
    ...
    _onClose() {
        ...
        if (this.dontShowAgainChecked && this.readMessageSetting) {
            game.settings.set('eon-rpg', this.readMessageSetting, true);
        }
        this.close();
    }
}